...
.form {
  .form-footer {
    @apply mt-8 pt-4 pb-8  flex align-middle;
    .link-item {
      @apply w-1/12 bg-white border border-grayscale-800  me-3 text-center block py-3 rounded-lg hover:bg-classic-rose-700 hover:text-baja-white-200 transition-all;
    }
    button {
